package engine.agent.families.cf4;
...
public class ConveyorFamilyFour extends Agent implements ConveyorFamilyInterface
{
	//DATA
	...
	//CONSTRUCTOR
	public ConveyorFamilyFour(String nombre, Transducer tdeuce)
	{
		super(nombre, tdeuce);
